...
export default function SloomooVideo({ setChangeScreen }) {
  ...
  const videoInfo = [
    {
      videoSrc: "/videos/Sloomoovie_part1.mp4",
      poem: "Sloomoo the slime loves spreading cheer\nWith squishy fun throughout the year!",
    },
    {
      videoSrc: "/videos/Sloomoovie_part2.mp4",
      poem: `As Christmas bells ring through the night
            Sloomoo misses friends tonight
Warm inside their empty home,
Sweet Sloomoo sits, all alone.`,
    },
    {
      videoSrc: "/videos/Sloomoovie_part3.mp4",
      poem: `But when the doorbell chimes ring sweet and clear
    A beautiful snow globe did appear!
    And on a note, words dancing in light
    "Make a wish and shake with all your might!"`,
    },
    {
      videoSrc: "/videos/Sloomoovie_part4.mp4",
      poem: `What's the wish that made Sloomoo's heart soar?
        ...
        <section className="d-flex flex-column align-items-center justify-content-center p-2 ">
          <Card className="video-card d-flex flex-column align-items-center justify-content-center ">
            ...
            <Card.Body className="vc-body d-flex flex-column align-items-center justify-content-center">
              <div className="poem">{videoInfo[int].poem}</div>
            </Card.Body>
          </Card>
