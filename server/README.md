...
- **AI Integration**: Generates personalized poems using DeepSeek API.
- **Dynamic Image Generation**: Updates JSON workflows and integrates with ComfyUI to create flux-prompt-based images.
- **Real-Time Communication**: Powered by Socket.IO and Events Emitter to provide instant updates and notifications.
...
3. Create an .env file in the server directory with the following variables:
   ...
   #APIS
   DEEPSEEK_API_KEY='your api key goes here'
   ...
   #DIRECTORIES
   DOWNLOAD_DIR='comfyui output directory goes here'
   ```
